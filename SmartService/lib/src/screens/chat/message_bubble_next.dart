...
class MessageBubbleNext extends StatelessWidget {
  const MessageBubbleNext.next({
    super.key,
    required this.message,
    required this.isMe,
    required this.time,
          ...
          child: Column(
            ...
            children: [
              Text(
                message,
                style: TextStyle(
                  color: isMe ? (THelperFunctions.isDarkMode(context)
                    ? Colors.white
                    : Colors.black) : (THelperFunctions.isDarkMode(context)
                    ? Colors.white
                    : Colors.black),
                ),
              ),
