...
import 'package:smart_service/src/screens/verify_account/maps.dart';
...
class _LocationInputState extends State<LocationInput> {
  ...
  String get locationImage {
    ...
    return "https://maps.googleapis.com/maps/api/staticmap?center$lat,$lng,NY&zoom=13&size=600x300&maptype=roadmap&markers=color:red%7Clabel:S%7C$lat,$lng&key=AIzaSyCv7nzABmowHcgisZuOVJL8HvENMMQ-uxU";
  }

  Future<void> _savePlace(double latitude, double longitude) async {
    final url = Uri.parse(
      'https://maps.googleapis.com/maps/api/geocode/json?latlng=$latitude,$longitude&key=AIzaSyCv7nzABmowHcgisZuOVJL8HvENMMQ-uxU',
    );
