...
class RegisterController extends GetxController {
  ...
  Future<void> signup() async {
    try {
      // Vérification préalable de la politique
      ...
      final passwordError = TValidator.validatePassword(password.text.trim());
      ...
      // Validation du reste du formulaire
      if (!registerformKey.currentState!.validate()) {
        return;
      }

      // Start Loading seulement si tout est valide
