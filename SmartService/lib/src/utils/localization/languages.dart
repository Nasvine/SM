...
class Languages extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    ...
    'fr_FR': {
      ...
      "instructionCompanyAdresse":
          "Assurz-vous d'être dans votre l'entreprise.",
      ...
      "tSuccessCreateCompte":
          "Votre compte a bien été créé ! Veuillez vérifier votre adresse e-mail pour continuer.",
      "tVerifyEmailText":
          "Votre compte a bien été créé ! Consulter votre boite e-mail ou votre Spam pour verifier votre email. Si vous ne trouvez pas le lien de vérification, Appuyer sur le bouton Renvoyer la vérification.",
    },
    'fo_FO': {
      'email_hint': 'Entrer votre email',
      //Generic Text
      ...
      "tEmailSent": "Email Envoyé",
      "tEmailSentMessage":
          "Veuillez vérifier votre boîte de réception et vérifier votre e-mail.",
      "tSuccessCreateCompte":
          "Votre compte a bien été créé ! Veuillez vérifier votre adresse e-mail pour continuer.",
      "tVerifyEmailText":
          "Votre compte a bien été créé ! Consulter votre boite e-mail ou votre Spam pour verifier votre email. Si vous ne trouvez pas le lien de vérification, Appuyer sur le bouton Renvoyer la vérification.",
      ...
      //Welcome Screen
      "tWelcomeTitle": "Bienvenue sur Smart Service",
      "tWelcomeSubTitle":
          "Pour commencer, veuillez choisir les options suivants:",
